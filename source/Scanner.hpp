...
/** \brief Base class for all scanners.
 */
class Scanner
{
  public:
     ...
     */
    bool honoursTimeLimit() const noexcept;


     /** \brief Sets if time limit is considered between two requests.
      *
    ...
    /** \brief Sets the new silence mode.
     *
    ...
    void waitForHashLookupLimitExpiration();
      ...
      */
    virtual int64_t maxScanSize() const noexcept = 0;
  private:
