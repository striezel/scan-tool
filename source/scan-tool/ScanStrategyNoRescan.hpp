...
#ifndef SCANTOOL_VT_SCANSTRATEGYNORESCAN_HPP
#define SCANTOOL_VT_SCANSTRATEGYNORESCAN_HPP
...
/** \brief class that implements the scan strategy without any rescans
 */
class ScanStrategyNoRescan: public ScanStrategy
{
  public:
    ///constructor
    ScanStrategyNoRescan();


    /** \brief scan a given file using the default scan strategy, but without rescans
     *
...
#endif // SCANTOOL_VT_SCANSTRATEGYNORESCAN_HPP
