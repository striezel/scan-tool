...
#ifndef SCANTOOL_VT_SCANSTRATEGYSCANANDFORGET_HPP
#define SCANTOOL_VT_SCANSTRATEGYSCANANDFORGET_HPP
...
/** \brief class that implements a scan strategy where file is scanned only and no report is fetched
 */
class ScanStrategyScanAndForget: public ScanStrategy
{
  public:
    ///constructor
    ScanStrategyScanAndForget();


    /** \brief scan a given file using the "scan and forget" strategy
     *
...
#endif // SCANTOOL_VT_SCANSTRATEGYSCANANDFORGET_HPP
