...
ScanStrategyScanAndForget::ScanStrategyScanAndForget()
: ScanStrategy()
{
  //empty
}

int ScanStrategyScanAndForget::scan(ScannerV2& scanVT, const std::string& fileName,
              ...
              std::set<std::string>::size_type& totalFiles)
{
  ...
  /* Note:
     ...
     It even does not save the scan ID, so no scan reports will be retrieved
     afterwards by the main program.
   */
