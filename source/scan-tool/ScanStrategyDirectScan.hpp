...
#ifndef SCANTOOL_VT_SCANSTRATEGYDIRECTSCAN_HPP
#define SCANTOOL_VT_SCANSTRATEGYDIRECTSCAN_HPP
...
/** \brief class that implements a scan strategy where file is always scanned first
 */
class ScanStrategyDirectScan: public ScanStrategy
{
  public:
    ///constructor
    ScanStrategyDirectScan();


    /** \brief scan a given file using the direct scan strategy
     *
...
#endif // SCANTOOL_VT_SCANSTRATEGYDIRECTSCAN_HPP
